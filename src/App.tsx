      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/dang-tin" element={<AdminRoute><CreateListingPage /></AdminRoute>} />
            <Route path="/dang-tin-bien-so" element={<NotFound />} />
            <Route path="/chinh-sua-xe/:id" element={<AdminRoute><EditCarListingPage /></AdminRoute>} />
            <Route path="/chinh-sua-bien-so/:id" element={<NotFound />} />
            <Route path="/cai-dat" element={<AccountSettingsPage />} />
            <Route path="/quan-ly-tin" element={<AdminRoute><MyListingsPage /></AdminRoute>} />
